...
# Zorg dat deze import helemaal bovenaan in het bestand staat waar deze functie leeft!
from influx_helper import send_location_to_influx

def decrypt_location_response_locations(device_update_protobuf, device_name="Unknown", device_id="Unknown"):
